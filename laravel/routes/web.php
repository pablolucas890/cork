...
Route::get('/teste', function () {
    return view('teste', ['title' => 'teste', 'breadcrumb' => 'This Breadcrumb']);
})->name('teste');
/**
 * =======================
 *      LTR ROUTERS
...
foreach ($prefixRouters as $prefixRouter) {
    Route::prefix($prefixRouter)->group(function () {
        ...
        Route::get('/charts-line', function () {
            return view('pages.charts-line', ['title' => 'Apex Chart | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
        })->name('charts-line');
